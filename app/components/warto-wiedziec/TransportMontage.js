...
function MontageSection() {
  return (
    <section
      id="transport"
      className="flex max-sm:flex-col justify-center gap-10 md:py-10"
    >
      {/* LEFT COLUMN */}
      <div className="max-w-xl text-center px-2 ">
        ...
        <p>
          Niezależnie od wybranego rodzaju garażu, możesz być pewien, że montaż
          będzie precyzyjny i terminowy. Nasz proces montażu uwzględnia zarówno
          funkcjonalność, jak i estetykę, gwarantując, że Twój garaż będzie
          prezentować się doskonale. Ważne: Montaż odbędzie się pod warunkiem,
          że samochód ciężarowy będzie w stanie dojechać do wskazanego miejsca.
        </p>
      </div>
      {/* LEFT COLUMN */}
