...
function MoreInfos() {
  return (
    <div className='bg-[url("/images/hero_img3.jpg")] bg-cover  md:p-10 p-5 flex flex-col items-center h-[600px] bg-no-repeat bg-center'>
       <Fade>  <h2 className='text-4xl underline underline-offset-4 md:pb-20 pb-5 text-white '>Przydatne <span className='text-sky-500'>informacje</span></h2></Fade>
